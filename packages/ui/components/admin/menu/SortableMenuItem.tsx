...
export function SortableMenuItem({ 
  ...
  // Create a drop zone for nesting
  const {
    ...
    <div className="mb-1">
      ...
      <div
        ...
        className={`
          ...
          ${isDroppableOver ? 'ring-2 ring-green-500/50 bg-green-50/50' : ''}
          ${depth > 0 ? 'ml-8' : ''}
        `}
      >
        {/* Drop indicator for nesting */}
        {isDroppableOver && (
          <div className="absolute inset-0 border-2 border-dashed border-green-500 rounded-lg bg-green-50/20 pointer-events-none" />
        )}
